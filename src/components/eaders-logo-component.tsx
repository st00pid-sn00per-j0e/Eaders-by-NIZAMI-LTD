...
const EadersLogoComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g transform="translate(55, 0) scale(0.35)">
      ...
      <path d="M50 25V75C50 75 66.6667 70.8333 66.6667 50C66.6667 29.1667 50 25 50 25Z" fill="currentColor" fillOpacity="0.6"/>
      <path d="M50 25V75C50 75 33.3333 70.8333 33.3333 50C33.3333 29.1667 50 25 50 25Z" fill="currentColor" fillOpacity="0.6"/>
